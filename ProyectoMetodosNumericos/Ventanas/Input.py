...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.leImage = QtGui.QLabel(self.groupParameters)
        self.leImage.setGeometry(QtCore.QRect(390, 80, 251, 241))
        self.leImage.setObjectName(_fromUtf8("leImage"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.leImage.setText(_translate("MainWindow", "Placeholder", None))
