...
# Form implementation generated from reading ui file 'mwindow.ui'
#
# Created: Mon May 12 16:44:05 2014
#      by: PyQt4 UI code generator 4.9.6
#
# WARNING! All changes made in this file will be lost!
...
class Ui_MWindow(object):
    def setupUi(self, MWindow):
        ...
        self.retranslateUi(MWindow)
        QtCore.QMetaObject.connectSlotsByName(MWindow)
        MWindow.setTabOrder(self.leEquation, self.cboMethod)
        MWindow.setTabOrder(self.cboMethod, self.leParam1)
        MWindow.setTabOrder(self.leParam1, self.leParam2)
        MWindow.setTabOrder(self.leParam2, self.leParam3)
        MWindow.setTabOrder(self.leParam3, self.leParam4)
        MWindow.setTabOrder(self.leParam4, self.leParam5)
        MWindow.setTabOrder(self.leParam5, self.pbCalculate)
        MWindow.setTabOrder(self.pbCalculate, self.teSteps)
