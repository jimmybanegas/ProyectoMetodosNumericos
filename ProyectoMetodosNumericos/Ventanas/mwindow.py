...
class Ui_MWindow(object):
    def setupUi(self, MWindow):
        ...
        self.pbCalculate.setGeometry(QtCore.QRect(524, 82, 141, 31))
        self.pbPasos = QtGui.QPushButton(self.groupParameters)
        self.pbPasos.setGeometry(QtCore.QRect(530, 40, 110, 25))
        font = QtGui.QFont()
        ...
        self.lbResult.setGeometry(QtCore.QRect(545, 450, 181, 21))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(430, 450, 101, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pbClear.setGeometry(QtCore.QRect(10, 440, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MWindow):
        ...
        self.pbPasos.setText(_translate("MWindow", "Pasos", None))
        self.pushButtonOtros.setText(_translate("MWindow", "Otros", None))
        self.label_3.setText(_translate("MWindow", "Resultado:", None))
        self.pbClear.setText(_translate("MWindow", "Limpiar Historial", None))
